...
const single1 = new song('Hayya Hayya (Better Together FIFA WC OFFICIAL SOUNDTRACK)', 'Trinidad Cardona, Davido y Aysha', 'Pop', 50)
const single2 = new song('Bizarrap - Nicky Jam', 'Nicky Jam', 'Reggaeton', 70)
const single3 = new song('Desfilar mis penas (prod. ASAN', 'YSY A', 'Trap', 100)
...
const single7 = new song('En la ciudad de la furia', 'Soda Stereo', 'Rock Nacional', 300)
